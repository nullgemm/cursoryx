...
folder_library="\$folder_cursoryx/lib/cursoryx/win"
...
{ \
echo "# copy headers"; \
echo "build \$folder_include/cursoryx_win.h: \$"; \
echo "cp src/include/cursoryx_win.h"; \
echo ""; \
} >> "$output/$ninja_file"

{ \
echo "build headers: phony \$"; \
echo "\$folder_include/cursoryx_win.h"; \
echo ""; \
} >> "$output/$ninja_file"
