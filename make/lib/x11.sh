...
folder_library="\$folder_cursoryx/lib/cursoryx/x11"
...
{ \
echo "# copy headers"; \
echo "build \$folder_include/cursoryx_x11.h: \$"; \
echo "cp src/include/cursoryx_x11.h"; \
echo ""; \
} >> "$output/$ninja_file"

{ \
echo "build headers: phony \$"; \
echo "\$folder_include/cursoryx_x11.h"; \
echo ""; \
} >> "$output/$ninja_file"
