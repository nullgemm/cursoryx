...
folder_library="\$folder_cursoryx/lib/cursoryx/wayland"
folder_include="\$folder_cursoryx/include"
name="cursoryx_wayland"
cc="gcc"
ld="ld"
ar="ar"
objcopy="objcopy"
...
{ \
echo "# copy headers"; \
echo "build \$folder_include/cursoryx_wayland.h: \$"; \
echo "cp src/include/cursoryx_wayland.h"; \
echo ""; \
} >> "$output/$ninja_file"

{ \
echo "build headers: phony \$"; \
echo "\$folder_include/cursoryx_wayland.h"; \
echo ""; \
} >> "$output/$ninja_file"
